...
export default function about() {
  return (
    <>
    <div id="Aboutus" className='duration-300 md:pb-10 md:pt-20 lg:pt-20 pt-5 text-black mx-auto md:text-center md:px-10 px-5'>
        <div className='max-w-screen-xl border-b pb-10 border-[#136690] border-opacity-30 mx-auto'>
            <div className='mx-auto pt-5'>
                <h1 className='text-left lg:text-4xl text-2xl md:pt-5 pt-3 font-medium text-[#1A2B6B]'>
                    About Us
                </h1>
