    ...
    <div id="Aboutus" className='duration-300 md:pb-10 md:py-40 py-20 lg:py-40 text-black mx-auto md:text-center md:px-10 px-5'>
        <div className='max-w-screen-xl border-b pb-10 border-[#136690] border-opacity-30 mx-auto'>
            <div className='mx-auto pt-5'>
                <h1 data-aos="zoom-in-up" data-aos-delay="300" data-aos-duration="400" className='text-left md:text-center mx-auto lg:text-4xl text-2xl md:pt-5 font-medium text-[#1A2B6B]'>
                    About Us
                </h1>
                <div data-aos="zoom-in-up" data-aos-delay="300" data-aos-duration="400" className='mx-auto justify-center max-w-screen-lg'>
                ...
                <div data-aos="zoom-in-up" data-aos-delay="300" data-aos-duration="400" className='flex mt-5 md:text-center text-left md:mx-auto md:justify-center'>
                    <a 
