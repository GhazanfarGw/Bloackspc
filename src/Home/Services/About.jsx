...
const App = () => {
  ...
  return (
    <div className="md:px-10 px-5 max-w-screen-xl justify-center mx-auto items-center">
        <div className='text-black mx-auto md:pt-20 md:pb-32 pt-10 justify-center items-center'>
            <h1 className="lg:text-4xl text-2xl md:pt-5 pt-3 font-medium md:text-center mx-auto text-[#1A2B6B]">Our Services</h1>
            <div className="tabs justify-center mx-auto text-center md:pt-20 pt-5">
                {tabs.map((tab) => (
                <button
                    key={tab.title}
