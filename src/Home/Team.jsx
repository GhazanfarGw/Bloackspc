        ...
        <div className='mx-auto justify-center md:px-10 px-5 max-w-screen-xl py-10 md:py-16'>
            ...
            <div className='md:pt-10 pt-5'>
                ...
                <div>
                    ...
                    <p className='text-[#6D7380] text-sm leading-normal pl-4'>
            ...
            <div className='md:py-16 py-8'>
                <h1 className='text-[#1A2B6B] text-lg font-semibold'>
                    Key Members
                </h1>   
                <div className='xl:grid xl:grid-cols-4 lg:grid lg:grid-cols-4 md:grid md:grid-cols-2 md:gap-5 gap-3'>
                    <div className='border px-5 py-5 md:py-10 md:px-5 md:mt-10 border-opacity-30 mt-5 bg-white'>
