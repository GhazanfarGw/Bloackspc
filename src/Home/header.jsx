      ...
      {isScrolled ? (
            <header onClick={handleScrollToTop} className="fixed z-10 md:px-10 px-3 w-full duration-500 mx-auto items-center bg-[#ffffff] md:py-2 border-b border-opacity-30">
              ...
              >
                ...
                <li>
                  <a href='/careers' className="tracking-wider border-b border-opacity-30 px-8 py-3 flex flex-row items-center duration-200 hover:text-[#1A2B6B] text-[#000] border-[#403f68] text-sm leading-normal">
                    Careers
                  </a>
                  <div className='border-b border-[#fff] border-opacity-30 mx-3'/>
                </li>
        ...
        <div className="flex items-center">
          <div className="flex items-center max-w-screen-xl justify-between mx-auto w-full">
            ...
            <ul className="md:flex hidden items-center w-full justify-end mx-auto">
              ...
              <li>
                <Link to="/careers" className="items-center text-sm tracking-wider relative h-8 pt-0.5 duration-200 pr-16 flex justify-center flex-row hover:text-[#1A2B6B] text-[#000]">
                  Careers
                </Link>
              </li>
              <div className='flex'>
