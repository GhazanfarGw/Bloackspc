...
const Business = () => {
    return (
        <>
        <Header/>
            <div id="Blocksphere" className='justify-center mx-auto items-center duration-300 md:py-32 py-20'>
                <div className='mx-auto justify-center items-center max-w-screen-xl md:px-10 px-5'>
                    <div className='justify-center py-5 gap-16 items-center pb-16'>
                        <div className='mx-auto'>
                            <h1 className='lg:text-4xl text-2xl md:pt-5 pt-3 font-medium md:text-center mx-auto text-[#1A2B6B]'>
                                Why BlockSphere?
                            </h1>
                            <p className='text-[#6D7380] justify-center md:text-base text-sm pt-5 leading-normal max-w-screen-md mx-auto md:text-center'>
                            ...
                            <p className='text-sm pt-5 leading-normal md:text-base md:text-center mx-auto text-[#6D7380] max-w-screen-md'>
                            ...
                            <div className='xl:grid xl:grid-cols-4 lg:grid lg:grid-cols-3 md:grid md:grid-cols-2 md:gap-5 gap-3 text-[#C3CDD3]'>
                                <div className='border px-5 py-5 md:py-16 md:px-5 md:mt-10 border-opacity-30 mt-5'>
                                    ...
                                    <h1 className='text-lg md:font-medium lg:pt-5 pt-3 text-[#1A2B6B]'>
                                        Paper wallet protection
                                    </h1>
                                    <p className='md:pt-5 pt-3 text-[#6D7380] text-sm leading-normal'>
                                ...
                                <div className='border px-5 py-5 md:py-16 md:px-5 md:mt-10 border-opacity-30 mt-5'>
                                    ...
                                    <h1 className='text-base md:font-medium lg:pt-5 pt-3 text-[#1A2B6B]'>
